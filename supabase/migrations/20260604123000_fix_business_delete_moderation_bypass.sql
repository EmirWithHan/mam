...
comment on function public.delete_my_business_account()
  is 'Trusted owner-only business delete RPC. It sets a local moderation bypass only after ownership is verified, restores user profile mode, marks the business deleted, cancels future business events, and clears sponsorship fields.';
